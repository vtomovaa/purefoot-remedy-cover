...
<body>
    <div class="image-logo-1">
        <img src="../images/logo-01.webp" class="product" />
    </div>
    <div class="div-wrapper">

        <div class="image-product">
            <img src="../images/purefoot.webp" class="product" />
        </div>

        <div class="header-name">
            <p class="name-product">PureFoot Remedy</p>
            ...
            <p class="name-product-text"><i class="far fa-check-circle"></i> Order Number: #500911</p>
